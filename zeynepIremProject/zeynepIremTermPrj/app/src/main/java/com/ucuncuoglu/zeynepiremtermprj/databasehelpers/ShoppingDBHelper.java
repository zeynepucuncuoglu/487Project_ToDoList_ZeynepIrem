package com.ucuncuoglu.zeynepiremtermprj.databasehelpers;
...
public class ShoppingDBHelper extends SQLiteOpenHelper {
    public static String DATABASE_NAME="shoppingDB";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            db.execSQL(ShoppingTable.CREATE_TABLE_SQL);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        try {
            db.execSQL(ShoppingTable.DROP_TABLE_SQL);
        }catch (SQLException e){
            e.printStackTrace();
        }
        onCreate(db);

...
public class MyRecyclerViewSocialAdapter extends RecyclerView.Adapter<MyRecyclerViewSocialAdapter.MyRecyclerViewItemHolder> {
    private Context context;
    private ArrayList<Activity> recyclerItemValues;
    SocialDBHelper socialdbHelper;

    public MyRecyclerViewSocialAdapter(Context context, ArrayList<Activity> values){
        this.context = context;
        this.recyclerItemValues = values;
        socialdbHelper = new SocialDBHelper(context);
    }
    ...
    public void onBindViewHolder(@NonNull MyRecyclerViewItemHolder myRecyclerViewItemHolder, int i) {
        ...
        myRecyclerViewItemHolder.btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                boolean res = SocialTable.delete(socialdbHelper, sp.getId()+"");

...
public class SocialTable {
    public static String TABLE_NAME="social";
    ...
    public static ArrayList<Activity> getAllSocials(SocialDBHelper dbHelper){
        Activity anItem;
    ...
    public static ArrayList<Activity> findContact(SocialDBHelper dbHelper, String key) {
        Activity anItem;
        ArrayList<Activity> data = new ArrayList<>();
    ...
    public static boolean insert(SocialDBHelper dbHelper, int id, String topic, String dueDate) {
    ...
    public static boolean update(SocialDBHelper dbHelper, String id, String topic, String dueDate) {
    ...
    public static boolean delete(SocialDBHelper dbHelper, String id){

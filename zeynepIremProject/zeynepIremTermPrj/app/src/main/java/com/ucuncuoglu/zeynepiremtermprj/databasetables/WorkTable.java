...
public class WorkTable {
    public static String TABLE_NAME="work";
    ...
    public static ArrayList<Activity> getAllWorks(WorkDBHelper dbHelper){
        Activity anItem;
    ...
    public static ArrayList<Activity> findContact(WorkDBHelper dbHelper, String key) {
        Activity anItem;
        ArrayList<Activity> data = new ArrayList<>();
    ...
    public static boolean insert(WorkDBHelper dbHelper, int id, String topic, String dueDate) {
    ...
    public static boolean update(WorkDBHelper dbHelper, String id, String topic, String dueDate) {
    ...
    public static boolean delete(WorkDBHelper dbHelper, String id){

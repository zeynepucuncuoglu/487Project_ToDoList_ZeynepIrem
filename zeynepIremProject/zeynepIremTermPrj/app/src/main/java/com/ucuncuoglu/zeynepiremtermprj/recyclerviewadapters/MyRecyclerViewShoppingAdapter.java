...
public class MyRecyclerViewShoppingAdapter extends RecyclerView.Adapter<MyRecyclerViewShoppingAdapter.MyRecyclerViewItemHolder> {
    private Context context;
    private ArrayList<Activity> recyclerItemValues;
    ShoppingDBHelper shopdbHelper;


    public MyRecyclerViewShoppingAdapter(Context context, ArrayList<Activity> values){
        this.context = context;
        this.recyclerItemValues = values;
        shopdbHelper = new ShoppingDBHelper(context);
    }
    ...
    public void onBindViewHolder(@NonNull MyRecyclerViewItemHolder myRecyclerViewItemHolder, int i) {
        ...
        myRecyclerViewItemHolder.btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                boolean res = ShoppingTable.delete(shopdbHelper, sp.getId()+"");
